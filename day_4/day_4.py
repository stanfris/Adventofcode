    ...
    for boardn in range(1, 101):
        ...
        for i in range(5):
            ...
            if fields[boardn][i][0] == 'x' and fields[boardn][i][1] == 'x' and fields[boardn][i][2] == 'x' and fields[boardn][i][3] == 'x' and fields[boardn][i][4] == 'x':
                ...
                for rown in range(5):
                    for coln in range(5):
                        if fields[boardn][rown][coln] != 'x':
                            total += fields[boardn][rown][coln]
                total = total * draw
                print(total)

                quit()

            if fields[boardn][0][i] == 'x' and fields[boardn][1][i] == 'x' and fields[boardn][2][i] == 'x' and fields[boardn][3][i] == 'x' and fields[boardn][4][i] == 'x':
